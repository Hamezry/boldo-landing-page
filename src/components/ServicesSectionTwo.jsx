import { servicesTwo } from "../dummyData";

const ServicesSectionTwo = () => {
  return (
    <section className="md:container mx-auto mt-20 sm:mt-28 md:px-28 px-5 sm:px-10">
      {servicesTwo.map((service, index) => (
        ...
        >
          ...
          <div className="sm:col-span-3 md:col-span-1 pt-10 sm:pt-24">
            <h3 className="mb-8 text-[26px] leading-8 sm:leading-[50px] xs:text-3xl tracking-tight text-gray-900 sm:text-4xl text-left">
              {service.title}
            </h3>
            ...
            <button
              className={`${
                index === 1 && "hidden"
              } mt-6 md:mt-8 rounded-full bg-[#0A2640] px-10 py-2.5 text-lg font-semibold text-white hover:bg-white hover:ring-2 hover:ring-[#0A2640] hover:text-[#0A2640] duration-300`}
            >
              Start now
            </button>
          </div>
